...
#define PAN_FS_CLIENT_IOC_LOOKUP \
	_IOWR(PAN_FS_CLIENT_SDK_IOCTL, 11, struct pan_fs_client_ioctl_lookup_args_s)
...
typedef struct pan_fs_client_ioctl_get_attr_args_s pan_fs_client_ioctl_get_attr_args_t;
...
#define PAN_FS_CLIENT_IOC_ATTR_GET \
	_IOWR(PAN_FS_CLIENT_SDK_IOCTL, 1, struct pan_fs_client_ioctl_get_attr_args_holder_s)
...
/**
 * An ioctl command for setting PanFS attributes. PanFS specific ACLs can also be
 * set using this ioctl.
 *
 * @author  ssubbarayan
 * @version 1.0
 *
...
typedef struct pan_fs_client_ioctl_set_attr_args_s pan_fs_client_ioctl_set_attr_args_t;
...
#define PAN_FS_CLIENT_IOC_ATTR_SET \
	_IOWR(PAN_FS_CLIENT_SDK_IOCTL, 3, struct pan_fs_client_ioctl_set_attr_args_holder_s)
